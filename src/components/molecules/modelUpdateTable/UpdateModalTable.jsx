...
export default function UpdateModalTable(props) {
	...
	return (
		<ModalWindow setModalIsOpen={props.setIsEditModalOpen}>
			<div className='p-4 border-b flex justify-between items-center'>
				<h2 className='text-xl poppins'>Edit Row</h2>
				<button
			...
			<div className='p-6 open-sans'>
              ...
              ${isIdField ? 'cursor-not-allowed bg-black-alpha-70' : ''}`}
										/>
									</>
								)}
								{column.type === 'VARCHAR' && (
